defmodule ElixirLS.LanguageServer.SourceFile do
  ...
  @spec formatter_for(String.t(), String.t()) :: {:ok, {function | nil, keyword()}} | :error
  def formatter_for(uri = "file:" <> _, project_dir) do
    ...
    try do
      ...
      if Version.match?(System.version(), ">= 1.13.0") do
        opts = [dot_formatter: Path.join(project_dir, ".formatter.exs")]
        {:ok, apply(Mix.Tasks.Format, :formatter_for_file, [path, opts])}
      else
